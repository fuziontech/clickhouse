...
| `MultiPoint` (GeoParquet) | [MultiPoint](/sql-reference/data-types/geo.md#multipoint) |
...
| [MultiPoint](/sql-reference/data-types/geo.md#multipoint) | `BYTE_ARRAY` (WKB) + GeoParquet metadata |
...
| `output_format_parquet_geometadata`                                            | Write GeoParquet `geo` metadata into the Parquet file footer and encode top-level ClickHouse geo columns ([`Point`](/sql-reference/data-types/geo.md#point), [`MultiPoint`](/sql-reference/data-types/geo.md#multipoint), [`LineString`](/sql-reference/data-types/geo.md#linestring), [`Polygon`](/sql-reference/data-types/geo.md#polygon), [`MultiLineString`](/sql-reference/data-types/geo.md#multilinestring), [`MultiPolygon`](/sql-reference/data-types/geo.md#multipolygon)) as WKB. If `0`, those columns are written using their native underlying representation (e.g. `Point` as `Tuple(Float64, Float64)`) and no GeoParquet metadata is emitted.                                                                                                                                                                          | `1`         |
