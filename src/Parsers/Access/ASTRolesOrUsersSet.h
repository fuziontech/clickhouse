...
public:
    ...
    /// Query parameters in names ignored because ALL/ANY dominates. Keep only their metadata:
    /// retaining the ASTs would make them invisible to the AST size limit and formatter.
    ...
    bool hasIgnoredQueryParameters() const { return !ignored_query_parameter_names.empty(); }
